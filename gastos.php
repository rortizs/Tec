...
<div class="modal fade" tabindex="-1" role="dialog" id="removeGastoModal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">   <!--Declaramos las clases para la eliminacion de gastos -->
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> Eliminar Gasto</h4><!--funcionamiento del boton eliminar gasto -->
      </div>
      <div class="modal-body">

      	<div class="removeGastoMessages"></div>  <!--creamos el mensaje de confirmacion. -->

        <p>Realmente deseas eliminar el Gasto?</p> <!--Declaramos el mensaje de confirmacion. -->
      </div>
      <div class="modal-footer removeGastoFooter">
        <button type="button" class="btn btn-default" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> Cancelar</button> <!--Declaramos las acciones del boton cancelar -->
        <button type="button" class="btn btn-primary" id="removeGastoBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> Eliminar</button> <!--Declaramos las acciones del boton siguiente-->
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->

<!--End Eliminar Gasto Modal -->
